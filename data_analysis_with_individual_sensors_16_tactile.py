...
# ================== Serial config ==================
serial_port = "COM6"
baud_rate = 921600   # IMPORTANT: Teensy Serial.begin() must also be 921600

output_file = "C:/Users/12179/OneDrive/Desktop/GT Grad/CapStone Cassie/Data Collection/Force Testing For Relationship/Random_Test0_nothing.csv"
...
try:
    ...
    with serial.Serial(serial_port, baud_rate, timeout=0.1) as ser, \
            open(output_file, "w", newline='', buffering=1024 * 1024) as file:
        ...
        while time.time() - start_time < end_time:
            ...
            # ----- normalize tactile -----
            tactile_norm = [
                tactile_fixed[i] - tactile_baseline[i]
                for i in range(num_tactile)
            ]
            ...
            if sample_count % 100 == 0:
                ...
                print(
                    ...
                    f"Python rate: {sample_count / elapsed:.2f} Hz, "
...
if len(timestamps) > 0:
    ...
    fig.suptitle(
        "Back Tactile Sensors per Array "
        "(Baseline-Normalized, 8 sensors each)",
        y=0.98
    )
    fig.tight_layout()
    plt.show()
